...
void tama_mem_scene_wiring_on_enter(void* context) {
...
bool tama_mem_scene_wiring_on_event(void* context, SceneManagerEvent event) {
    UNUSED(context);
    UNUSED(event);
    return false;
}
void tama_mem_scene_wiring_on_exit(void* context) {
    SPIMemApp* app = context;
