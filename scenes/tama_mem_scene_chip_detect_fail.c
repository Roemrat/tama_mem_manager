...
static void tama_mem_scene_chip_detect_fail_widget_callback(
...
void tama_mem_scene_chip_detect_fail_on_enter(void* context) {
    SPIMemApp* app = context;
    ...
    widget_add_button_element(
        ...
        GuiButtonTypeCenter,
        "Retry",
        tama_mem_scene_chip_detect_fail_widget_callback,
        app);
...
bool tama_mem_scene_chip_detect_fail_on_event(void* context, SceneManagerEvent event) {
    SPIMemApp* app = context;
    bool success = false;
...
void tama_mem_scene_chip_detect_fail_on_exit(void* context) {
    SPIMemApp* app = context;
