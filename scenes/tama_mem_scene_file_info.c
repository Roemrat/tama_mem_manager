...
void tama_mem_scene_file_info_on_enter(void* context) {
    SPIMemApp* app = context;
    FuriString* str = furi_string_alloc();
    furi_string_printf(str, "Size: %zu KB", tama_mem_file_get_size(app) / 1024);
...
bool tama_mem_scene_file_info_on_event(void* context, SceneManagerEvent event) {
    SPIMemApp* app = context;
    bool success = false;
...
void tama_mem_scene_file_info_on_exit(void* context) {
    SPIMemApp* app = context;
