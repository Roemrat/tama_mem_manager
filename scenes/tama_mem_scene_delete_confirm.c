...
static void tama_mem_scene_delete_confirm_widget_callback(
...
void tama_mem_scene_delete_confirm_on_enter(void* context) {
    SPIMemApp* app = context;
    ...
    widget_add_button_element(
        ...
        GuiButtonTypeLeft,
        "Cancel",
        tama_mem_scene_delete_confirm_widget_callback,
        app);
    widget_add_button_element(
        app->widget,
        GuiButtonTypeRight,
...
bool tama_mem_scene_delete_confirm_on_event(void* context, SceneManagerEvent event) {
    SPIMemApp* app = context;
    bool success = false;
...
void tama_mem_scene_delete_confirm_on_exit(void* context) {
    SPIMemApp* app = context;
